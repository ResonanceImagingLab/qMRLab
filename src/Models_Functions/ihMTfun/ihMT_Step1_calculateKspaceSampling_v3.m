function [outputSamplingTable, measuredElem, iSegments] = ihMT_Step1_calculateKspaceSampling_v3(Params)
...
[outputSamplingTable, measuredElem, iSegments] = ihMT_calcGeneratingFunctionTables_v3(AngleOrderFunc, RadiusOrderFunc,iNumElements,iTurboFactor,mask);
