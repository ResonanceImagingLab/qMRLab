function [M_perp2, M_z2] = ihMT_computeSpinDiffusion(M_perp, M_z, Params, gam, G, G_t, t)
...
M_perp2 = ihMT_fixConvolutionViaInterp(M_perp2,'pchip',6);
...
M_z2 = ihMT_fixConvolutionViaInterp(M_z2,'linear',10);
