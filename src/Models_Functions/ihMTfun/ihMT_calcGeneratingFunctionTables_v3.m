function [FinalMat, m_iNumberOfMeasuredElements, iSegments] = ihMT_calcGeneratingFunctionTables_v3(AngleOrderFunc, RadiusOrderFunc, iNumElements, iTurboFactor, mask) 
