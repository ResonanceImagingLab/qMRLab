function [raiSegmentationGeneratingFunction, raiOrderGeneratingFunction] = ihMT_generatePieSegFunOrdFun(iNumLines,iNumPartitions,iCenterLine,iCenterPartition, iNumElements) 
