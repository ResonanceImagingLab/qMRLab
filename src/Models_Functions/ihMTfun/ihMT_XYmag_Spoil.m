function M_out = ihMT_XYmag_Spoil(Params, M_in, t, MTC, Gradient)
...
if Params.PerfectSpoiling
    M_out = ihMT_spinEvolution_Relaxation( Params, M_in, t); % Calculate relaxation over period t
    M_out(1:2,:) = 0; % Spoil. Easier to do if you are keeping isochromats
else

    M_out = ihMT_applySpinEvolution_v2( Params, M_in, t, MTC, Gradient );
