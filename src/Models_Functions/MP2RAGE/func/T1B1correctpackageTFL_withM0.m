function [ T1corr, MP2RAGEcorrected, M0map_corr] = T1B1correctpackageTFL_withM0( B1img, MP2RAGEimg, MP2RAGEINV2nii, MP2RAGE, brain, InvEff)
...
if nargin < 5 || isempty(brain)
    ...
    %     brain = MP2RAGEimg;
    % end
    brain.img = ones(size(MP2RAGEINV2nii.img));
    brain.img(MP2RAGEINV2nii.img < 100) = 0;
end
...
M0map_corr.img(M0map_corr.img<0) = 0;
