...
properties 
    ...
    Prot = struct('PulseSequenceParams', struct('Format',{{'MTC'; 'delta(Hz)' ;...
        'flipAngle(deg)' ; 'TR(ms)' ; 'numSatPulse' ; 'TurboFactor' ; ...
        'pulseDur(ms)' ; 'satFlipAngle(deg)' ; 'pulseGapDur(ms)' ;...
        'DummyEcho' ; 'LowDutyCycle'; 'satTrainPerBoost' ;...
        'TR_MT(ms)'; 'echoSpacing(ms)'}}, ...
